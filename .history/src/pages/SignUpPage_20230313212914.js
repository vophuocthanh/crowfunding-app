...
const SignUpPage = () => {
  ...
  return (
    <LayoutAuthentication heading="SignUp">
      ...
      <button className="flex items-center justify-center py-4 gap-x-3 w-full border border-strock rounded-xl text-text2 text-base font-semibold mb-5 dark:text-white">
        <img srcSet="./icon-google.png 2x" alt="icon-google" />
        <span>Sign up with google</span>
      </button>
      <p className="text-center text-sx lg:text-sm font-normal mb-4 lg:mb-8 text-text2 dark:text-white">
      ...
      <form onSubmit={handleSubmit(handleSignUp)}>
        ...
        <div className="flex items-start gap-x-5 mb-5">
          <Checkbox name="term" checked={acceptTerm} onClick={handleToggleTerm}>
            <p className="text-sm text-text2 flex-1 lg:text-sm">
              I agree to the{" "}
